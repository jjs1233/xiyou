...
<head>
  <meta charset="utf-8">
  <title>接口设置 - <?php echo C('Site.Title');?></title>
...
<div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">接口设置</strong> / <small>微信接口</small></div>
    </div>
    <hr/>
      ...
      <div class="am-u-sm-12 am-u-md-8">
        <form class="am-form am-form-horizontal" action="" method="post">
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-name" name="old" value="">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-name" name="new" value="">
            </div>
          </div>
