...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo U('notice/add');?>" class="btn btn-success">添加公告</a>
        </div>
        <div class="col-md-6">
            <form action="<?php echo U('notice/index');?>" method="post">
                <div class="form-group input-group">
                    <input type="text" class="form-control" name="key" placeholder="输入公告关键词搜索">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                ...
                <td><a href="<?php echo U('notice/update',array('id'=>$v['id']));?>">编辑</a> | <a href="<?php echo U('notice/delete',array('id'=>$v['id']));?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
