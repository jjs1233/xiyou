...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo U('user/add');?>" class="btn btn-success">添加用户</a>
        </div>
        <div class="col-md-6">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
                ...
                <td><?php echo get_sex($v.sex); ?></td>
                <td><?php echo ($v["class"]); ?></td>
                <td><?php echo ($v["grade"]); ?></td>
                <td><a href="<?php echo U('user/update',array('id'=>$v['user_id']));?>">编辑</a> | <a href="<?php echo U('user/delete',array('id'=>$v['user_id']));?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
