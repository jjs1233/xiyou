...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('friend/update');?>">
        <div class="form-group">
            <label for="aa">主人账号</label>
            <input type="text" name="master" class="form-control" id="aa" placeholder="输入主人账号" value= "<?php echo ($model['master']['mobile']); ?>">
        </div>
        <div class="form-group">
            <label for="aa">朋友账号</label>
            <input type="text" name="friend" class="form-control" id="aa" value= "<?php echo ($model['friend']['mobile']); ?>" placeholder="输入朋友账号">
        </div>
