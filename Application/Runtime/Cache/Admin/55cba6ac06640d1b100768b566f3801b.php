...
<div id="page-wrapper">
    <form method="post" action="<?php echo U('growth/update');?>">
        <div class="form-group">
            <label for="aa">金钱</label>
            <input type="text" name="money" class="form-control" id="aa" placeholder="输入用户名" value= "<?php echo ($model['money']); ?>">
        </div>
        <div class="form-group">
            <label for="aa">灵气</label>
            <input type="text" name="soul" class="form-control" id="aa" value= "<?php echo ($model['soul']); ?>" placeholder="输入密码">
        </div>
         <div class="form-group">
            <label for="aa">日期</label>
            <input type="text" name="date" class="form-control" id="aa" value= "<?php echo ($model['date']); ?>" placeholder="输入密码">
        </div>
        <div class="form-group">
            <label for="aa">账号</label>
            <input type="text" name="mobile" class="form-control" id="aa" value= "<?php echo ($model['user']['mobile']); ?>" placeholder="输入账号">
        </div>
