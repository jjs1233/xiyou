...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="<?php echo U('growth/add');?>" class="btn btn-success">添加成长</a>
        </div>
        <div class="col-md-6">
            <form action="<?php echo U('growth/index');?>" method="post">
                <div class="form-group input-group">
                    <input type="text" class="form-control" name="key" placeholder="输入金钱或灵气关键词搜索">
    ...
    <table class="table table-hover table-striped">
        ...
        <?php if(is_array($model)): foreach($model as $key=>$v): ?><tr>
            <td><?php echo ($v["id"]); ?></td>
                ...
                <td><?php echo ($v["soul"]); ?></td>
                <td><?php echo ($v["date"]); ?></td>
                <td><?php echo ($v['user']['mobile']); ?></td>
                <td><a href="<?php echo U('growth/update',array('id'=>$v['id']));?>">编辑</a> | <a href="<?php echo U('growth/delete',array('id'=>$v['id']));?>" style="color:red;" onclick="javascript:return del('您真的确定要删除吗？\n\n删除后将不能恢复!');">删除</a></td>
