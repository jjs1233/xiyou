...
<div id="wrapper">
    ...
    <li class="dropdown">
        <a href="<?php echo U('member/index');?>"><i class="fa fa-users"></i> 会员管理</a>  
    </li>
     <li class="dropdown">
...
<!-- 配置文件 -->
<script type="text/javascript" src="/xiyou/Public/ueditor/ueditor.config.js"></script>
<!-- 编辑器源码文件 -->
<script type="text/javascript" src="/xiyou/Public/ueditor/ueditor.all.js"></script>
<!-- 实例化编辑器 -->
